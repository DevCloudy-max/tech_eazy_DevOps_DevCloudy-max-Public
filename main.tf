...
resource "aws_instance" "ec2_instance" {
  ...
  iam_instance_profile = try(aws_iam_instance_profile.ec2_instance_profile[0].name, null)
...
resource "aws_instance" "reader_instance" {
  ami                  = var.AMI_img_Id
  instance_type        = var.instance_type
  iam_instance_profile = try(aws_iam_instance_profile.read_instance_profile[0].name, null)
  key_name             = aws_key_pair.generated_key.key_name
